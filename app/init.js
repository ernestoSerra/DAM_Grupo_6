		...
		SceneScene1.prototype.handleKeyDown = function (keyCode) {
			...
			switch (keyCode) {
				...
				case sf.key.DOWN:
					...
					break;
				case sf.key.ENTER:
					var currentElement = findCurrent();
		...
		SceneSceneGeneros.prototype.handleKeyDown = function (keyCode) {
			...
			switch (keyCode) {
				...
				case sf.key.ENTER:
					...
					if(currentElement=="0,0"){
						genero='28';
					}else if(currentElement=="0,1"){
						genero='16';
					}else if(currentElement=="0,2"){
						genero='12';
					}else if(currentElement=="0,3"){
						genero='878';
					}else if(currentElement=="1,0"){
						genero='35';
					}else if(currentElement=="1,1"){
						genero='99';
					}else if(currentElement=="1,2"){
						genero='18';
					}else if(currentElement=="1,3"){
						genero='27';
					}
					sf.scene.hide('SceneGeneros');
